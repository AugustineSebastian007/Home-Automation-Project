...
import 'package:home_automation/features/rooms/presentation/pages/room_details.page.dart'
    as details;
  ...
  static final router = GoRouter(
      ...
      routes: [
        ...
        ShellRoute(
            ...
            routes: [
              ...
              GoRoute(
                  ...
                  pageBuilder: (context, state) {
                    return NoTransitionPage(child: RoomsPage());
                  }),
              GoRoute(
                  parentNavigatorKey: Utils.tabNav,
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              details.RoomDetailsPage(roomId: state.pathParameters['id']!),
        ),
      ]);
}